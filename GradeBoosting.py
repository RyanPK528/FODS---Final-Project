...
X = salary_data[['text_features', 'skill_level'] + list(encoded_df.columns)]  # Include one-hot encoded columns
...
gb_param_dist = {
    ...
    'regressor__learning_rate': uniform(0.01, 0.3), # Use uniform for learning rate
    'regressor__max_depth': [3, 5, 7, None],  # Reduce max_depth range for GB
...
gb_random_search = RandomizedSearchCV(
    ...
    n_iter=50,  # Potentially reduce n_iter if runtime is too long
    cv=5,
    scoring='r2',
    verbose=1,
    random_state=42,
